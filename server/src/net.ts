...
const residentialHosts = (process.env.RESIDENTIAL_HOSTS || 'reddit.com,bsky.app,gdeltproject.org,trustpilot.com,gql.twitch.tv,syndication.twitter.com,pullpush.io')
  .split(',')
