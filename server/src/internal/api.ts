...
import { runSocialIntelOnce, runCustomQuery, twDiag } from './socialintel.ts'
...
export function registerSocialIntel(app: FastifyInstance): void {
  ...
  app.get('/api/internal/social/stats', async (req, reply) => {
    ...
    return { byProduct, pendingDrafts: pending, collected24h: last24, total, health, unclassified, twDiag }
  })
